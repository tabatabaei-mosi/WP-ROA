...
def write_solution(
    ...
    Args:
        solution (np.array, list): original solution generated by optimizer
    ...
    Return:
        None
    """
    # ? Why do u have to define a function within a function? 
...
def npv_calculator(npv_constants):
    ...
    Args:
        npv_constants (dictionary): The constants to use in npv formula
...
def run_simulator():
    ...
    # ! You may have to change it, with one parent, f'{abs_to_src}/model'
    working_dir = f'{abs_to_src}/src/model'
    # open a file to log the simulator report
    # ! You have to fix this problem: (1) add '/' before 'src' or (2) use one parent and only the variable
